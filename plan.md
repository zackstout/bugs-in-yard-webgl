...
## Spatial Layout Engine _(target design — not built until Phase 5)_
...
### Phase 1 — Interaction Proof _(build this first)_
...
### Phase 7 — Advanced Features _(if needed)_
...
_Documented skeptically — these are not blockers, but they need answers before or during Phase 1._

---

### 1. ~~The MVP is still large~~ — _Resolved_
...
### 2. ~~The layout engine abstraction may be premature~~ — _Resolved_
...
### 3. The Vue / Three.js boundary — _Decision recorded_
...
### 4. ~~Where does the data actually come from?~~ — _Resolved_
...
### 5. ~~The conventional website layer doubles the work~~ — _Resolved_
...
### 6. Uneven collections — _Decision recorded_
...
### 7. Taxonomy data source — _Decision recorded_
...
### 8. Mobile scope — _Decision recorded_
